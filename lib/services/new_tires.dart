...
class NewTires extends StatefulWidget {
  @override
  State<NewTires> createState() => _NewTiresState();
}

class _NewTiresState extends State<NewTires> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(
                'If you have replaced your tires, please fill up the details to record your service.',
                textAlign: TextAlign.start,
                style: GoogleFonts.poppins(
                  fontSize: 16,
