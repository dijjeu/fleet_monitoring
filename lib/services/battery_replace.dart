...
class BatteryReplace extends StatefulWidget {
  @override
  State<BatteryReplace> createState() => _BatteryReplaceState();
}

class _BatteryReplaceState extends State<BatteryReplace> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(
                'If you had replaced a new battery, please fill up the details to record your service.',
                textAlign: TextAlign.start,
                style: GoogleFonts.poppins(
                  fontSize: 16,
